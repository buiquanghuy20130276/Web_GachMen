                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="about-desc">
                            ...
                            <p class="mb-20">
                                Được thành lập vào năm 2020, TrueMart là Nhà Nhập khẩu & Phân phối Gạch Sứ Mỹ chính tại Việt Nam, có thể cung cấp tất cả các yêu cầu về gạch ốp lát cho các công trình gia dụng, kiến trúc, thiết kế nội thất và xây dựng.</p>
                            <h5 class="mb-10 about-title">NHIỆM VỤ</h5>
                            <p>Trở thành ĐỐI TÁC THẬT SỰ CỦA BẠN trong việc tạo kiểu dáng cho không gian của bạn với chất lượng vững chắc và gạch lát nền, gạch ốp tường và gạch trang trí hợp thời trang của chúng tôi.
                            </p>
