                                ...
                                <c:forEach items="${listCart}" var="product">
                                    <tr>
                                        <td class="product-thumbnail">
                                            <input name="productID" value="/UpdateCart?quantity=${product.productID}" type="hidden">
                                        ...
                                        <td class="product-quantity"><input name="quantity" type="number" value="/UpdateCart?quantity=${product.quantityCart}"></td>
